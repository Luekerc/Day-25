...
gulp.task('clean', require('del').bind(null, ['.tmp', 'Day-25']));
...
gulp.task('build', ['jshint', 'html', 'images', 'fonts', 'extras', 'distStyles'], function () {
  return gulp.src('Day-25/**/*').pipe($.size({title: 'build', gzip: true}));
});
